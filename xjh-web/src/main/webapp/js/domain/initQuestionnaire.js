var showquestionnaire=function($dialog ,id,mode){
	...
	var danxxiang="<li><label><input name='a' id='xxgroup' type='radio' ><span class='xxwenzi' id=''></span></label></li>";
	var duoxxiang="<li><label><input name='a' id='xxgroup' type='checkbox' /><span class='xxwenzi' id=''></span></label></li>";
	...
	setTimeout(function(){$.get(Optionurl).done(function(json){
		...
		for(var i in json){
			...
			$dialog.find(".xxwenzi").last(). siblings("#xxgroup").attr("name",a);
		}
